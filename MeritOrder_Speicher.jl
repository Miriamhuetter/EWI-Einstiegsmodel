...
s_set = ["Pumpspeicher", "Batteriespeicher"] #Speicher
...
DE = hcat(DE_df, DataFrame(
     hcat(FR_df[:,:DE], NL_df[:,:DE], PL_df[:,:DE], SE_df[:,:DE], NO_df[:,:DE], Pumpspeicher[:,:DE], PS_Speicherstand[:,:DE], Batteriespeicher[:,:DE], BS_Speicherstand[:,:DE], Nachfrage_df[:,:DE], Strompreise[:,:DE]), 
     ["FR_ex", "NL_ex", "PL_ex", "SE_ex", "NO_ex", "PS_Einspeicherung", "PS_Speicherstand", "BS_Einspeicherung", "BS_Speicherstand", "Nachfrage", "Strompreis"]))

FR = hcat(FR_df, DataFrame(
     hcat(DE_df[:,:FR], NL_df[:,:FR], PL_df[:,:FR], SE_df[:,:FR], NO_df[:,:FR], Pumpspeicher[:,:FR], PS_Speicherstand[:,:FR], Batteriespeicher[:,:FR], BS_Speicherstand[:,:FR], Nachfrage_df[:,:FR], Strompreise[:,:FR]), 
     ["DE_ex", "NL_ex", "PL_ex", "SE_ex", "NO_ex", "PS_Einspeicherung", "PS_Speicherstand", "BS_Einspeicherung", "BS_Speicherstand", "Nachfrage", "Strompreis"]))

NL = hcat(NL_df, DataFrame(
     hcat(DE_df[:,:NL], FR_df[:,:NL], PL_df[:,:NL], SE_df[:,:NL], NO_df[:,:NL], Pumpspeicher[:,:NL], PS_Speicherstand[:,:NL], Batteriespeicher[:,:NL], BS_Speicherstand[:,:NL], Nachfrage_df[:,:NL], Strompreise[:,:NL]), 
     ["DE_ex", "FR_ex", "PL_ex", "SE_ex", "NO_ex", "PS_Einspeicherung", "PS_Speicherstand", "BS_Einspeicherung", "BS_Speicherstand", "Nachfrage", "Strompreis"]))

PL = hcat(PL_df, DataFrame(
     hcat(DE_df[:,:PL], FR_df[:,:PL], NL_df[:,:PL], SE_df[:,:PL], NO_df[:,:PL], Pumpspeicher[:,:PL], PS_Speicherstand[:,:PL], Batteriespeicher[:,:PL], BS_Speicherstand[:,:PL], Nachfrage_df[:,:PL], Strompreise[:,:PL]), 
     ["DE_ex", "FR_ex", "NL_ex", "SE_ex", "NO_ex", "PS_Einspeicherung", "PS_Speicherstand", "BS_Einspeicherung", "BS_Speicherstand", "Nachfrage", "Strompreis"]))
   
SE = hcat(SE_df, DataFrame(
     hcat(DE_df[:,:SE], FR_df[:,:SE], NL_df[:,:SE], PL_df[:,:SE], NO_df[:,:SE], Pumpspeicher[:,:SE], PS_Speicherstand[:,:SE], Batteriespeicher[:,:SE], BS_Speicherstand[:,:SE], Nachfrage_df[:,:SE], Strompreise[:,:SE]), 
     ["DE_ex", "FR_ex", "NL_ex", "PL_ex", "NO_ex", "PS_Einspeicherung", "PS_Speicherstand", "BS_Einspeicherung", "BS_Speicherstand", "Nachfrage", "Strompreis"]))
   
NO = hcat(NO_df, DataFrame(
     hcat(DE_df[:,:NO], FR_df[:,:NO], NL_df[:,:NO], PL_df[:,:NO], SE_df[:,:NO], Pumpspeicher[:,:NO], PS_Speicherstand[:,:NO], Batteriespeicher[:,:NO], BS_Speicherstand[:,:NO], Nachfrage_df[:,:NO], Strompreise[:,:NO]), 
     ["DE_ex", "FR_ex", "NL_ex", "PL_ex", "SE_ex", "PS_Einspeicherung", "PS_Speicherstand", "BS_Einspeicherung", "BS_Speicherstand", "Nachfrage", "Strompreis"]))
